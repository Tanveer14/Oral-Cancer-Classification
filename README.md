# Cancer Stage Prediction – CSE 5819 Project

This repository contains the code and data used for developing machine learning models to predict oral cancer stages based on demographic, clinical, lifestyle, and diagnostic features.

This GitHub project includes **two Python scripts** and **one input dataset**.
